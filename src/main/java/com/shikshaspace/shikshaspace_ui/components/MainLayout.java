...
/**
 * Production-grade responsive MainLayout with modern premium design
...
public class MainLayout extends AppLayout {
    ...
    public MainLayout() {
        ...
        getElement().getStyle()
                .set("--vaadin-app-layout-drawer-overlay", "true");
    }

    /**
     * Create responsive header with mobile-first approach
     * - Mobile: Hamburger + Logo + Avatar only
     * - Desktop: Hamburger + Logo + Username + Avatar
     */
    private void createResponsiveHeader() {
        ...
        logo.getStyle()
                .set("color", "white")
                .set("font-weight", "600")
                .set("font-size", "clamp(1.2rem, 4vw, 1.75rem)") // Responsive font
        ...
        header.getStyle()
                ...
                .set("top", "0")
                .set("z-index", "1000")
                .set("padding", "clamp(8px, 2vw, 16px)"); // Responsive padding

        addToNavbar(header);
    }

    /**
     * Create responsive profile dropdown menu
     * Hides username label on mobile devices
     */
    private MenuBar createResponsiveProfileMenu() {
        ...
        usernameLabel.addClassNames(
                LumoUtility.Display.Breakpoint.Small.HIDDEN,
                "username-label"
        );
     ...
     * Used for profile dropdown options
     */
    ...
    /**
     * Create responsive navigation drawer (sidebar)
     * Overlay on mobile, permanent sidebar on desktop
     */
    ...
    /**
     * Helper to create responsive navigation link with modern premium design
     * Supports both Class<? extends Component> and String routes
     */
    private RouterLink createResponsiveNavLink(VaadinIcon iconType, String text,
