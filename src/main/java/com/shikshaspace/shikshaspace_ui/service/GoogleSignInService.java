...
/**
 * Service for handling Google Sign-In OAuth2 flow. Handles both JavaScript SDK initialization and
...
public class GoogleSignInService {
  ...
  /**
   * Initialize Google Sign-In button with JavaScript SDK. This method loads the Google library and
  ...
  public void initializeGoogleSignIn(Consumer<String> onSuccess) {
    ...
    log.info(
        "✅ Google Sign-In initialized with client ID: {}...",
